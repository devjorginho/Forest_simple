...
/*   Updated: 2025/07/18 18:45:57 by jde-carv         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
		...
		float y)
{
	...
	background = ft_calloc(1, sizeof(t_entity));
	background->position = ft_calloc(1, sizeof(t_position));
	background->sprite = ft_calloc(1, sizeof(t_sprite));
...
void	e_background(t_game *game)
{
	...
	image_path = ft_strdup("assets/background/back-1.xpm");
	index = 0;
	while (index < 5)
	{
